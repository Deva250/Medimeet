...
const VerificationPage =  async() => {
  ...
  <CardHeader className="text-center"> 
    ...
    className={`mx-auto p-4 ${
        ...
        {isRejected?(
            ...
            :( <ClipboardCheck className='h-8 w-8 text-amber-400'></ClipboardCheck>)
         }
    </div>
    <CardTitle 
    ...
    <CardDescription>
      {
        isRejected?"Unfortunately, your appliction needs revision"
        :"Thankyou for sumbitting your information"
      }
    </CardDescription>
  ...
  <CardContent>
   {
    isRejected?(<div className='bg-red-900/10 border border-900/20 rounded-lg-p-4 mb-6 flex items-start'>
    ...
    </div>):(<div className='bg-amber-900/10 border border-900/20 rounded-lg-p-4 mb-6 flex items-start'>
