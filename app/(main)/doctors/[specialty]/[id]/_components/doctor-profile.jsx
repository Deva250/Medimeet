        ...
        <div className="md:sticky md:top-24">
          <Card className="border-emerald-900/20">
            <CardContent className="pt-6 text-center">
              <div className="relative w-32 h-32 rounded-full overflow-hidden mb-4 bg-emerald-900/20 mx-auto">
                {doctor.imageUrl ? (
                  <Image
                    src={doctor.imageUrl}
                    alt={doctor.name}
                ...
                {totalSlots > 0 ? (
                  ...
                  <div className="text-center py-6">
                    ...
                    <p className="text-muted-foreground">
                      ...
                      for the next 4 days. Please check back later or try another doctor.
                    </p>
                  </div>
                )}
              </CardContent>
